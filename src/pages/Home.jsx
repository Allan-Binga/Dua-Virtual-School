...
function Home() {
    ...
    return (
        <div className="bg-stone-50 text-gray-800 min-h-screen">
            {/* Premium Navigation */}
            <header className={`fixed w-full top-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-white py-2 sm:py-4' : 'bg-transparent py-3 sm:py-6'}`}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 flex justify-between items-center">
                    <h1 className="text-2xl sm:text-3xl font-bold tracking-tight" style={{
                    ...
                    <nav className={`${isMenuOpen ? 'block' : 'hidden'} md:flex md:space-x-8 text-sm font-medium absolute md:static top-12 right-4 bg-white md:bg-transparent p-4 md:p-0 rounded shadow-lg md:shadow-none`}>
                        {['Home', 'About Us', 'Courses', 'Contact'].map((item) => (
                            <a
                                key={item}
                                href={`#${item.toLowerCase().replace(' ', '-')}`}
                                onClick={(e) => { e.preventDefault(); scrollToSection(item.toLowerCase().replace(' ', '-')); }}
                                className={`block py-2 md:inline-block transition-colors duration-200 ${isScrolled ? 'text-gray-700 hover:text-amber-800' : 'text-white hover:text-amber-200'}`}
                            >
                                {item}
                            </a>
                        ))}
            ...
            <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center px-4 sm:px-6 max-w-5xl">
                    <div className="mb-4 sm:mb-8 inline-block">
                        <span className="bg-amber-100 text-amber-900 px-4 sm:px-6 py-1 sm:py-2 rounded-sm text-xs sm:text-sm font-semibold tracking-wide">
                    ...
                    <p className="text-lg sm:text-2xl md:text-3xl text-amber-100 mb-6 sm:mb-12 font-light min-h-[30px] sm:min-h-[40px]">
                        {welcomeText}
                        <span className={`inline-block w-1 sm:w-2 h-6 sm:h-8 bg-amber-100 ${blink ? 'opacity-100' : 'opacity-0'} transition-opacity duration-500`}></span>
                    </p>
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                        <button className="bg-white text-amber-900 px-6 sm:px-8 py-3 sm:py-4 rounded-sm font-semibold hover:bg-amber-50 transition-all duration-300 transform hover:scale-105 shadow-xl text-sm sm:text-base">
                            Register Now
                        </button>
                        <button className="bg-transparent border-2 border-white text-white px-6 sm:px-8 py-3 sm:py-4 rounded-sm font-semibold hover:bg-white hover:text-amber-900 transition-all duration-300 text-sm sm:text-base">
                            Book Appointment
                        </button>
                    </div>
                </div>
            ...
            <section className="py-12 sm:py-24 px-4 sm:px-6 bg-white">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    <p className="text-sm sm:text-xl text-gray-600 mb-4 sm:mb-8 leading-relaxed max-w-3xl mx-auto">
                    ...
                    <button className="bg-gradient-to-r from-amber-700 to-orange-600 text-white px-6 sm:px-10 py-3 sm:py-5 rounded-sm font-bold text-base sm:text-lg hover:from-amber-800 hover:to-orange-700 transition-all duration-300 transform hover:scale-105 shadow-xl">
            ...
            {/* About Us Section */}
            <section id="about-us" className="py-12 sm:py-24 px-4 sm:px-6 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-8 sm:mb-16">
                        <h2 className="text-3xl sm:text-5xl font-bold text-gray-900 mb-2 sm:mb-4">About Us</h2>
                        <div className="w-16 sm:w-24 h-1 bg-gradient-to-r from-amber-800 to-orange-600 mx-auto"></div>
                    </div>
                    ...
                    <div className="grid gap-6 sm:gap-8 sm:grid-cols-1 md:grid-cols-3">
                        {[
                            ...
                            <div
                                key={index}
                                className="group relative bg-gradient-to-br from-amber-50 to-orange-50 p-4 sm:p-8 rounded-sm shadow-sm hover:shadow-2xl transition-all duration-500 border border-amber-100"
                            >
                                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-amber-700 to-orange-600 rounded-sm"></div>
                                <h3 className="text-xl sm:text-2xl font-bold text-amber-900 mb-2 sm:mb-4">{item.title}</h3>
                                {item.list ? (
                                    <ul className="list-disc pl-4 sm:pl-5 text-gray-700 space-y-2 sm:space-y-3">
                                        {item.list.map((point, i) => (
                                            <li key={i} className="leading-relaxed text-sm sm:text-base">{point}</li>
                                        ))}
                                    </ul>
                                ) : (
            ...
            {/* Why Choose Us */}
            <section id="courses" className="py-12 sm:py-24 px-4 sm:px-6 bg-gradient-to-br from-stone-100 to-amber-50">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-8 sm:mb-16">
                        <h2 className="text-3xl sm:text-5xl font-bold text-gray-900 mb-2 sm:mb-4">Why Choose Us?</h2>
                        <div className="w-16 sm:w-24 h-1 bg-gradient-to-r from-amber-800 to-orange-600 mx-auto mb-2 sm:mb-6"></div>
                        <p className="text-sm sm:text-xl text-gray-600 max-w-3xl mx-auto">Experience excellence in education with our comprehensive approach</p>
                    </div>
                    ...
                    <div className="grid gap-6 sm:gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                        {[
                            ...
                            <div key={index} className="bg-white p-4 sm:p-8 rounded-sm shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-amber-100">
                                <div className="w-8 h-8 sm:w-12 sm:h-12 bg-gradient-to-br from-amber-700 to-orange-600 rounded-sm mb-3 sm:mb-6 flex items-center justify-center text-white font-bold text-lg sm:text-xl">
                                    {index + 1}
                                </div>
            ...
            <section className="py-12 sm:py-24 px-4 sm:px-6 bg-white">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-8 sm:mb-16">
                        <h2 className="text-3xl sm:text-5xl font-bold text-gray-900 mb-2 sm:mb-4">What We Offer</h2>
                        <div className="w-16 sm:w-24 h-1 bg-gradient-to-r from-amber-800 to-orange-600 mx-auto"></div>
                    </div>
                    ...
                    <Carousel>
                        {[
                            ...
                            <div key={index} className="max-w-xs sm:max-w-md md:max-w-2xl mx-auto">
                                <div className="bg-gradient-to-br from-amber-50 to-orange-50 p-4 sm:p-6 md:p-12 rounded-sm shadow-xl border border-amber-100">
                                    <img
                                        src={item.image}
                                        alt={item.title}
                                        className="w-full h-32 sm:h-48 md:h-64 object-cover rounded-sm mb-4 sm:mb-6"
                                    />
                                    <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-2 sm:mb-4">{item.title}</h3>
            ...
            <section id="contact" className="py-16 sm:py-32 px-4 sm:px-6 bg-gradient-to-br from-amber-900 via-orange-800 to-yellow-900 relative overflow-hidden">
                ...
                <div className="max-w-6xl mx-auto relative z-10">
                    <div className="text-center mb-8 sm:mb-16">
                        <h2 className="text-3xl sm:text-5xl md:text-6xl font-bold text-white mb-4 sm:mb-6">Get In Touch</h2>
                        <div className="w-16 sm:w-24 h-1 bg-white mx-auto mb-2 sm:mb-6"></div>
                        <p className="text-sm sm:text-xl text-amber-100 max-w-xl sm:max-w-2xl mx-auto">Ready to start your educational journey? We're here to answer all your questions.</p>
                    </div>

                    <div className="grid gap-8 sm:gap-12 sm:grid-cols-1 md:grid-cols-2 items-start">
                        {/* Contact Info */}
                        <div className="space-y-6 sm:space-y-8">
                            <div className="bg-white p-4 sm:p-8 rounded-sm border border-gray-300">
                                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">Contact Information</h3>
                                <div className="space-y-3 sm:space-y-4 text-gray-800 text-sm sm:text-base leading-relaxed">
                                    <p className="flex items-start">
                                        <Mail className="mr-2 sm:mr-3 h-4 sm:h-5 w-4 sm:w-5" />
                                        <span className="font-semibold">Email:</span>
                                        <span className="ml-1 sm:ml-2">info@duavirtualschool.com</span>
                                    </p>
                                    <p className="flex items-start">
                                        <Phone className="mr-2 sm:mr-3 h-4 sm:h-5 w-4 sm:w-5" />
                                        <span className="font-semibold">Phone:</span>
                                        <span className="ml-1 sm:ml-2">+254 712 345 678</span>
                                    </p>
                                    <p className="flex items-start">
                                        <Globe className="mr-2 sm:mr-3 h-4 sm:h-5 w-4 sm:w-5" />
                                        <span className="font-semibold">Location:</span>
                                        <span className="ml-1 sm:ml-2">Global Virtual Learning</span>
                                    </p>
                                </div>
                            </div>

                            <div className="bg-white p-4 sm:p-8 rounded-sm border border-gray-300">
                                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-4">Office Hours</h3>
                                <p className="text-gray-800 text-sm sm:text-base leading-relaxed">Monday - Friday: 8:00 AM - 5:00 PM EAT</p>
                                <p className="text-gray-800 text-sm sm:text-base leading-relaxed">Saturday: 9:00 AM - 2:00 PM EAT</p>
                            </div>
                        </div>

                        {/* Contact Form */}
                        <div className="bg-white p-4 sm:p-6 md:p-10 rounded-sm shadow-2xl">
                            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full p-2 sm:p-3 md:p-4 border-2 border-gray-200 rounded-sm focus:border-amber-700 focus:outline-none transition-colors text-sm sm:text-base"
                                        required
                                    />
                                </div>
                                <div>
                                ...
                                <div>
                                    <label className="block text-gray-700 font-semibold mb-1 sm:mb-2 text-sm sm:text-base">Your Message</label>
                                    <textarea
                                        name="message"
                                        value={formData.message}
                                        onChange={handleChange}
                                        placeholder="Tell us about your needs..."
                                        className="w-full p-2 sm:p-3 md:p-4 border-2 border-gray-200 rounded-sm focus:border-amber-700 focus:outline-none transition-colors h-20 sm:h-24 md:h-32 resize-none text-sm sm:text-base"
                                        required
                                    />
                                </div>
                                <button
                                    type="submit"
                                    className="w-full bg-gradient-to-r from-amber-700 to-orange-600 text-white py-2 sm:py-3 md:py-4 rounded-sm font-bold text-sm sm:text-base md:text-lg hover:from-amber-800 hover:to-orange-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
                                >
                                    Send Message
                                </button>
                            </form>
            ...
            <footer className="bg-gray-900 text-white py-6 sm:py-12 px-4 sm:px-6">
                <div className="max-w-7xl mx-auto">
                    <div className="grid gap-6 sm:gap-8 md:grid-cols-4 mb-6 sm:mb-8">
                        <div>
                            <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-4 bg-gradient-to-r from-amber-400 to-orange-400 bg-clip-text text-transparent">
                                Dua Virtual School
                            </h3>
                            <p className="text-gray-400 text-sm sm:text-base">Excellence in virtual education for global learners.</p>
                        </div>
                        <div>
                        ...
                        <div>
                            <h4 className="font-semibold mb-2 sm:mb-4 text-sm sm:text-base">Programs</h4>
                            <ul className="space-y-2 text-gray-400 text-sm sm:text-base">
                        ...
                        <div>
                            <h4 className="font-semibold mb-2 sm:mb-4 text-sm sm:text-base">Connect</h4>
                            <p className="text-gray-400 mb-1 sm:mb-2 text-sm sm:text-base">info@duavirtualschool.com</p>
                            <p className="text-gray-400 text-sm sm:text-base">+254 712 345 678</p>
                        </div>
                    </div>
                    <div className="border-t border-gray-800 pt-4 sm:pt-8 text-center text-gray-500 text-sm sm:text-base">
